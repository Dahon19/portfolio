...
export function CoverflowCarousel({
  ...
  return (
    <div
      className={cn("coverflow-carousel-wrapper w-full", className)}
    ...
    >
      <div className="relative" style={{ position: "relative" }}>
        <div
          ...
          className="coverflow-frame cursor-grab overflow-hidden outline-none active:cursor-grabbing"
          style={{
      ...
      {showCaption && active?.title && (
        <div
          key={selected}
          className="coverflow-caption"
        >
          <h3 className="coverflow-caption__title">
            {active.title}
          </h3>
          {active.subtitle && active.subtitle.trim().toLowerCase() !== active.title.trim().toLowerCase() && (
            <p className="coverflow-caption__subtitle">
              {active.subtitle}
            </p>
          )}
          {active.description && (
            <p className="coverflow-caption__description">
              {active.description}
            </p>
          )}
          {active.tags && active.tags.length > 0 && (
            <div className="coverflow-caption__tags">
              {active.tags.map((tag) => (
                <span key={tag} className="coverflow-caption__tag-chip">
                  {tag}
                </span>
              ))}
            </div>
